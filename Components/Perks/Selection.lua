local xPositions = {
    ...
    {
        -2.3 * settings.selectionIconSize,
        -settings.selectionIconSize * 0.8,
        settings.selectionIconSize * 0.8,
        2.3 * settings.selectionIconSize
    }, -- 4 options
    {
...
function InitializeSelectionWindow()
    ...
    PerkSelectionWindow.devtext:SetText(
        "Perks will be undergoing a large revamp in the coming weeks. \nPlease refrain from reporting bugged perks to staff."
    )
    ...
    for i = 1, #xPositions, 1 do
        PerkSelectionWindow.SelectionPool.Pool[i] =
            CreateFrame("Button", PerkSelectionWindow.SelectionPool.Pool[i], PerkSelectionWindow.SelectionPool)
