        ...
        function(msg)
            ...
            if (#msg > 3) then
                ...
                for specId, perk in ipairs(perks) do
                    ...
                    if perk then
                        -- print(dump(perk))
                        for _, spell in pairs(perk["Perk"]) do
