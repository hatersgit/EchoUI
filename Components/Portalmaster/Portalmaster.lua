...
function createPortalmasterSelectWindow()
    ...
    Portalmaster.header.close:SetScript(
        "OnClick",
        function()
            Portalmaster:Hide()
        end
    ...
    Portalmaster.body.Go =
        ...
        Portalmaster.body.Go,
        Portalmaster.body,
        Portalmaster.body:GetWidth(),
        tmogsettings.headerheight,
        "Go",
        8
    )
    ...
    SubscribeToForgeTopic(
        ForgeTopic.SHOW_PORTAL_MASTER_SELECT,
        function(msg)
            if msg == "0" then
                Portalmaster:Hide()
            else
    ...
    SubscribeToForgeTopic(
        ...
        function(msg)
            ...
            Portalmaster.body.zonedd.dd =
                CreateEchosDropDown("typedd", Portalmaster.body.zonedd, "Where", Portalmaster.body.zonedd.Id)
            Portalmaster:Show()
