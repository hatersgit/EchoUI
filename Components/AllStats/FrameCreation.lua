...
frameStatNames = {
    ...
    {
        "AllStatsFrameStatMeleeDamage",
        "AllStatsFrameStatMeleeSpeed",
        "AllStatsFrameStatMeleePower",
        "AllStatsFrameStatMeleeHit",
        "AllStatsFrameStatMeleeCrit",
        "AllStatsFrameStatMeleeExpert"
    },
    {
        "AllStatsFrameStatRangeDamage",
        "AllStatsFrameStatRangeSpeed",
        "AllStatsFrameStatRangePower",
        "AllStatsFrameStatRangeHit",
        "AllStatsFrameStatRangeCrit"
    },
    {
        "AllStatsFrameStatSpellDamage",
        "AllStatsFrameStatSpellHeal",
        "AllStatsFrameStatSpellHit",
        "AllStatsFrameStatSpellCrit",
        "AllStatsFrameStatSpellHaste",
        "AllStatsFrameStatSpellRegen"
    },
    {
        "AllStatsFrameStatDefense",
        "AllStatsFrameStatArmor",
        "AllStatsFrameStatDodge",
        "AllStatsFrameStatParry",
        "AllStatsFrameStatBlock",
        "AllStatsFrameStatResil"
    }
}

for _, v in pairs(customFrameStatNames) do
    table.insert(frameStatNames, v)
end
for _, v in pairs(customStatHeaderNames) do
...
AllStatsFrame.scrollframe =
    CreateFrame("ScrollFrame", "AllStatsScrollFrame", AllStatsFrame, "UIPanelScrollFrameTemplate")
