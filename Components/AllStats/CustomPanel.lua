...
customFrameStatNames = {
    {
        "AllStatsFrameStatThorns",
        "AllStatsFrameStatMastery",
        "AllStatsFrameStatAvoidance",
        "AllStatsFrameStatSpeed",
...
function initializeCustomStatFunctions()
    customStatToFunction = {
        {AllStatsFrameStatThorns, SetTertiaryStat, 17},
        {AllStatsFrameStatMastery, SetTertiaryStat, 18},
        {AllStatsFrameStatAvoidance, SetTertiaryStat, 19},
        {AllStatsFrameStatSpeed, SetTertiaryStat, 20},
        {AllStatsFrameStatLeech, SetTertiaryStat, 21}
    }
end
...
function SetTertiaryStat(statFrame, statID)
    ...
    PaperDollFormatStat(
        tertiaryStatLabel[statID],
        0,
        curTertiaryStatValue[statID],
        0,
        statFrame,
