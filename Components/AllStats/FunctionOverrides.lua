...
function PrintStats()
    statToFunction = {
        -- Base Stats
        {AllStatsFrameStat1, PaperDollFrame_SetStat, 1},
        {AllStatsFrameStat2, PaperDollFrame_SetStat, 2},
        {AllStatsFrameStat3, PaperDollFrame_SetStat, 3},
        {AllStatsFrameStat4, PaperDollFrame_SetStat, 4},
        {AllStatsFrameStat5, PaperDollFrame_SetStat, 5},
        {AllStatsFrameStatMeleeDamage, PaperDollFrame_SetDamage},
        ...
        {AllStatsFrameStatSpellRegen, PaperDollFrame_SetManaRegen},
        {AllStatsFrameStatArmor, PaperDollFrame_SetArmor},
        {AllStatsFrameStatDefense, PaperDollFrame_SetDefense},
        {AllStatsFrameStatDodge, PaperDollFrame_SetDodge},
        {AllStatsFrameStatParry, PaperDollFrame_SetParry},
        {AllStatsFrameStatBlock, PaperDollFrame_SetBlock},
